"""
消融实验: 移除多尺度融合 (No Multi-Scale Fusion)

基于 Bi-Attenfusion.py，移除 Layer1-Layer3 的注意力融合
"""
...
class NoMultiScaleCrossViTBackbone(nn.Module):
    """
    消融实验Backbone: 移除多尺度融合

    只在Layer4进行融合，Layer1-Layer3各自独立处理
    """
