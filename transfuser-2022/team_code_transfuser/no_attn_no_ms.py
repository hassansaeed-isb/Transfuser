"""
消融实验: 移除跨模态注意力 + 移除多尺度融合 (No Cross-Attention + No Multi-Scale)

基于 Bi-Attenfusion.py，组合 no_attn 和 no_multiscale
"""
...
class NoAttnNoMsCrossViTBackbone(nn.Module):
    """
    消融实验 Backbone: 无跨模态注意力 + 无多尺度融合

    仅在 Layer4 进行一次独立 MLP 处理
    """
