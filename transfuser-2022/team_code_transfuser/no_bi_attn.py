"""
消融实验: 移除双向注意力 (No Bidirectional Attention)

基于 Bi-Attenfusion.py，移除 img→lidar 方向的跨注意力
"""
...
class NoBiAttnCrossViTBackbone(nn.Module):
    """
    消融实验Backbone: 移除双向注意力

    仅保留 LiDAR→图像 的跨注意力方向
    """
    def __init__(self, config, image_architecture='resnet34', lidar_architecture='resnet18', use_velocity=True):
        ...
        self.crossvit1 = MultiScaleUniDirectional(
        ...
        self.crossvit2 = MultiScaleUniDirectional(
        ...
        self.crossvit3 = MultiScaleUniDirectional(
